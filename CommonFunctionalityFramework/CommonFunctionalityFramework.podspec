...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Rewardz"
  # spec.authors            = { "Rewardz" => "ankit._seeking_job@yahoo.co.in" }
  # spec.social_media_url   = "https://twitter.com/Rewardz"
  ...
  #spec.source_files  = "CommonFunctionalityFramework/CommonFunctionalityFramework","Classes", "Classes/**/*.{h,m}"
