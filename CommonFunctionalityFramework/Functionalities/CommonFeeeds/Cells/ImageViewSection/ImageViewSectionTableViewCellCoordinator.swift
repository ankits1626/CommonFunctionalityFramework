//
//  ImageViewSectionTableViewCellCoordinator.swift
...
class ImageViewSectionTableViewCellCoordinator: CommonFeedCellCoordinatorProtocol{
    
    var cellType: CommonFeedCellTypeProtocol{
        return ImageViewTableViewCellType()
    }
