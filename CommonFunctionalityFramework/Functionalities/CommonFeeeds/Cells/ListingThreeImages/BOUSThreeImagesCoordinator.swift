//
//  BOUSThreeImagesCoordinate.swift
...
class BOUSThreeImagesTableViewCellCoordinator :  CommonFeedCellCoordinatorProtocol{
    ...
    var cellType: CommonFeedCellTypeProtocol{
        return BOUSThreeImagesTableViewCellType()
    }
    
    func loadDataCell(_ inputModel: CommonFeedCellLoadDataModel) {
        if let cell  = inputModel.targetCell as? BOUSThreeImagesTableViewCell{
