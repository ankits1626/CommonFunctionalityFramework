//
//  CommonNominationCountCellCoordinator.swift
...
class CommonNominationCountCellCoordinator: CommonFeedCellCoordinatorProtocol{
    
    var cellType: CommonFeedCellTypeProtocol{
        return CommonNominationCountCellType()
    }
