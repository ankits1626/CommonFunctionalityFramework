//
//  BOUSTwoImagesCoordinator.swift
...
class BOUSTwoImageTableViewCellCoordinator :  CommonFeedCellCoordinatorProtocol{
    ...
    var cellType: CommonFeedCellTypeProtocol{
        return BOUSTwoImageTableViewCellType()
    }
    
    func loadDataCell(_ inputModel: CommonFeedCellLoadDataModel) {
        if let cell  = inputModel.targetCell as? BOUSTwoImageTableViewCell{
