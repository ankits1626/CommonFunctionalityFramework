...
target 'CommonFunctionalityFramework' do
...
#  pod 'UILoadControl', :git => 'https://github.com/ankits1626/UILoadControl', :branch => 'master'
  ...
  pod 'RewardzCommonComponents', :git => 'https://github.com/ankits1626/RewardzCommonComponents.git', :branch => 'enhancement/519_legrandRewardChanges'
